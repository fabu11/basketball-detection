...
frames = load_video("shots/longvids/1.mov", display=False)
h = compute_homography(longvids_frame_points, court_rw_points)
annotated = []
ballpos_list = []
...
make_frames, miss_frames = makemiss2(longvids_hoop_coords, ballpos_list)
